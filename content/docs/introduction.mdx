...
- **TUI App**: Run `prstack` for an interactive terminal interface to detect, inspect, open, diff and help managing your stacks with operations like PR creation, merging, and more.
