...
description: Learn to execute basic PR stacking workflows
---
...
This creates the stack: `main → feature-a → feature-b`
...
- Building features that require multiple layers (database, API, UI) that depend on each other
...
By default, this displays your stack with PR information. For faster execution without PR details (useful in scripts), use:
