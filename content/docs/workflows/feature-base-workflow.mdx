...
description: Learn to use feature bases as organizational unit
---

# Working on Multiple Parallel feature bases

Please see the [Feature Base Command](/docs/reference/feature-base) before reading about multiple parallel feature bases.
